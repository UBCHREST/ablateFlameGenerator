#ifndef ABLATEFLAMEGENERATOR_CONVERGENCECRITERIA_HPP
#define ABLATEFLAMEGENERATOR_CONVERGENCECRITERIA_HPP
...
#endif  // ABLATEFLAMEGENERATOR_CONVERGENCECRITERIA_HPP
